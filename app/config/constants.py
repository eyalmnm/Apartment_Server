...
class ErrorCodes(Enum):
    ...
    ERROR_CODE_USERNAME_ALREADY_TAKEN = 203
    ERROR_CODE_USER_NOT_FOUND = 204
    ...
    # Item Error Codes (1400 - 1499)
    ERROR_CODE_ITEM_NOT_FOUND = 1400

    # Question Error Codes (1500 - 1599)
    ERROR_CODE_QUESTION_NOT_FOUND = 1500

    # Answer Error Codes (1600 - 1699)
    ERROR_CODE_ANSWER_NOT_FOUND = 1600

    # Answer Error Codes (1700 - 1799)
    ERROR_CODE_FAILED_TO_STORE_PROJECT = 1700
